const subheadingsData = {
      ...
      content: (
        <>
          <p>
            ...
            interfaces, ensuring exceptional user experiences.
            <br />
            <br />
            In my spare time I like to read and write. I love Kurt Vonnegut,
            Stephen King, and Octavia Butler. I'm also a huge weather nerd and
  ...
  2: [
    {
      title: '2021 Associates Degree',
      content: (
        <>
          <p>Madison College - Madison, WI</p>
        </>
      ),
    },
  ],
  3: [
    {
      title: '2021 - 2024 Software Engineer II',
      content: (
        <>
          <p>TDS Telecom</p>
        </>
